package com.example.finalproject.util
    ...
    class SupabaseManager {
        companion object {
            ...
            private const val SUPABASE_KEY = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6IndkY3B2emRjdWtqdWttbXVkd21lIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NjAyNTk5NjgsImV4cCI6MjA3NTgzNTk2OH0.Ns64mh-dsLP9UWf50J0kZNbRLMAW9-Ltposw1UNIzWc"
            private const val TABLE_NAME = "users"
        }

        // Save user to Supabase - FIXED PARAMETERS
        suspend fun saveUserToCloud(firstName: String, lastName: String, email: String, profileImage: String = ""): Boolean {
